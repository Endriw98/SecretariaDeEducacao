...
function renderRelFuncionarios() {
  return `
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-4 mb-4">
          ...
          <button class="w-full bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700">Gerar Relatório PDF</button>
        </div>
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
          <div class="overflow-x-auto">
            <table class="w-full">
  ...
  return `
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-4 mb-4">
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-3">
            ...
            <div>
              <label class="block text-xs font-medium text-gray-600 mb-1">Tipo de Alteração</label>
              <select class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-300">
                <option>Todos</option>
            ...
            <table class="w-full">
              <thead class="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700">Detalhes</th>
                </tr>
              </thead>
              <tbody>
                <tr class="border-b border-gray-200 hover:bg-gray-50">
